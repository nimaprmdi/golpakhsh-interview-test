      ...
      <div className="w-full max-w-1224 ">
        ...
        <div className="flex h-full flex-wrap w-full bg-green-950 overflow-hidden" style={{ height: "751px" }}>
          <div className="hidden h-full lg:block w-full lg:w-1/2">
            <img className="object-cover object-top w-full" src={masonryImage4} alt="masonry-4" />
          </div>
          <div className="w-full lg:w-1/2 h-full flex flex-wrap">
            <div className="w-full h-1/2 flex">
              <img className="object-cover object-top w-1/2" src={masonryImage2} alt="masonry-4" />
              <img className="object-cover object-top w-1/2" src={masonryImage5} alt="masonry-5" />
            </div>

            <div className="w-full h-1/2 flex">
              <img className="object-cover object-top w-1/2" src={masonryImage1} alt="masonry-1" />
              <img className="object-cover object-top w-1/2" src={masonryImage3} alt="masonry-3" />
            </div>
          </div>
        </div>
      </div>
